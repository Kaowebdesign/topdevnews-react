    ...
    <footer className="footer">
        <div className="container-fluid">
            <div className="row align-items-start justify-content-between">
                ...
                <div className="col-xl-2 col-lg-3 col-md-6 col-12 mt-md-0 mt-4">
                ...
                <div className="col-xl-2 col-lg-3 col-md-6 col-12 footer__mail-links mt-4 mt-lg-0">
                ...
                <div className="col-xl-2 col-lg-3 col-md-6 col-12 mt-4 mt-lg-0">
